  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto px-6 py-2">
        <div className="grid md:grid-cols-3 gap-8 mb-10">
          <div className={`transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            <div className="bg-black text-white p-4 mb-2">
              <h3 className="text-[1.3rem] font-bold">Why a Custom Fit Matters</h3>
            </div>
            <div className="bg-gray-50 p-6 space-y-4 text-[0.8rem]">
          ...
          <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            <div className="bg-black text-white p-4 mb-2">
              <h3 className="text-[1.3rem] font-bold">The Shama Cycles Approach</h3>
            </div>
            <div className="bg-gray-50 p-6 space-y-4 text-[0.8rem]">
              ...
              <p>Being the largest Guru dealer in the world gives us an advantage in bike fittings and frame design.</p>
            </div>
          </div>

          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            <div className="bg-black text-white p-4 mb-2">
              <h3 className="text-[1.3rem] font-bold">Proven Results</h3>
            </div>
            <div className="bg-gray-50 p-6 space-y-4 text-[0.8rem]">
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-center mb-10 text-black">Find the perfect fit for you</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className={`bg-black text-white p-8 rounded-lg transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'} hover:shadow-2xl hover:scale-105 transition-transform`}>
              <div className="flex items-center gap-3 mb-6">
                <div className="text-4xl">👑</div>
                <h3 className="text-xl font-bold">Pro Bike Fit</h3>
                <span className="text-xl font-bold ml-auto">$150</span>
              </div>
              <div className="space-y-3">
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Evaluate cleat, crank, saddle, stem, and bar for optimal sizing and placement</p>
                </div>
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Use power spin scan analysis and video for detailed before-and-after comparisons</p>
                </div>
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Receive personalized recommendations to enhance fit and riding experience</p>
                </div>
              </div>
            </div>
            ...
            <div className={`bg-black text-white p-8 rounded-lg transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'} hover:shadow-2xl hover:scale-105 transition-transform`}>
              <div className="flex items-center gap-3 mb-6">
                <div className="text-4xl">🎯</div>
                <h3 className="text-xl font-bold">Retul Bike Fit</h3>
                <span className="text-xl font-bold ml-auto">$250</span>
              </div>
              <div className="space-y-3">
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Includes professional fit enhanced with the Retul 3D Motion Capture System</p>
                </div>
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Captures precise motion data often missed by the naked eye during adjustments</p>
                </div>
                <div className="flex gap-3">
                  <Check className="w-5 h-5 shrink-0 text-green-400" />
                  <p className='text-[0.9rem]'>Ideal for riders with imbalances or those who love detailed performance data</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-10 rounded">
          <p className="text-gray-800 text-[0.9rem]">We don&apos;t believe fits are always a one-visit fix. Big changes may require multiple visits, and new equipment needs adaptation time. That&apos;s why we don&apos;t charge for follow-up fits. </p>
        </div>
