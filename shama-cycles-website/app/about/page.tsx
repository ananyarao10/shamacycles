    ...
    <div className="relative overflow-hidden px-6 py-12">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="bg-white rounded-lg p-4 shadow-md hover:-translate-y-2 hover:shadow-lg transition-all">
              ...
              <div className="text-gray-700 text-sm">We understand that every rider has a distinct style, taste, and set of goals. Whether you&apos;re racing or exploring gravel roads, we take the time to understand what matters most to you.</div>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-md hover:-translate-y-2 hover:shadow-lg transition-all">
              <div className="font-bold mb-2">Focused, Not Rushed</div>
              <div className="text-gray-700 text-sm">Every build and service we do is intentional. We believe that bike building and detailing should be focused and never rushed, so every ride feels right.</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="bg-white rounded-lg p-4 shadow-md hover:-translate-y-2 hover:shadow-lg transition-all">
              ...
              <div className="text-gray-700 text-sm">We start with your goals, preferences, and budget.</div>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-md hover:-translate-y-2 hover:shadow-lg transition-all">
      ...
      <section className="px-6 py-12 border-t border-gray-200 flex flex-col md:flex-row gap-12 items-start justify-center mb-8 mx-auto">
        ...
        <div className="max-w-xl space-y-4 mt-10">
          ...
          <p className='mt-3'>Philip Shama loves many things. He enjoys fresh brewed coffee in the morning, watching Le Tour (well, actually all tours), and spending time with his family. But he&apos;s also one of those people lucky enough to say he really loves his job.</p>
